...
teraabuqaiser = '\n\x1b[1;32m___ ____ ____ _  _    \n\x1b[1;33m |  |___ |    |__|    \n\x1b[1;32m |  |___ |___ |  |    \n\n\x1b[1;33m Fb : MUHAMMAD BILAL \n\x1b[1;32m YOUTUBE :- TECH QAISER \n\x1b[1;33m NEED HELP GO AND SUB THANKS \n__________________________________\n'
import os
import sys
import time
import requests
...
def qaiserallinone():
    ...
    if pepek == '':
        ...
        time.sleep(4)
        print "2. SPECIAL THANKS TO AMIR'Oo For\n Providing Me A List Of Commands "
        time.sleep(5)
        print '3. SPECIALLY IDEA & CREADTED BY TECH QAISER'
        time.sleep(5)
        os.system('xdg-open https://m.youtube.com/channel/UCOaenAmj6A-bPrzT3ynDEbw')
        qaiserallinone()
